...
import bg from '../../../media/DonationPage/donation.png'
...
const DonationForm = () => {
  ...
  return (
    <>
    <div className={`h-screen  fixed -z-20 flex justify-center  top-0 w-full bg-cover bg-center`} style={{backgroundImage:`url(${bg})`}}> </div>
        <div className='flex h-full w-full flex-col justify-center items-center '>
                     <div className='flex w-full justify-start bg-gray-600/40 backdrop-blur-lg  py-4 px-12 gap-5 lg:w-[70%]  lg:mt-3 text-white'>
