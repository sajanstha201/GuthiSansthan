    ...
    return (
        <>
            <div className="fixed bottom-0 h-[200px] w-full justify-center flex items-center overflow-hidden">
                ...
                >
                    <div className="fixed bottom-0 -z-20 bg-cover bg-center h-[200px] w-full opacity-70"
                ...
                <div className={`${isMobile ? 'bg-gray-300/40 backdrop-blur-md rounded-tl-md rounded-tr-md' : ''} z-10 absolute bottom-0 w-full justify-evenly items-center flex flex-row text-white font-bold`}>
                    {[
                        ...
                        <div key={section} className={`${isMobile ? 'px-3' : 'px-16'} home-footer-div flex flex-col items-center justify-center hover:scale-150 transition-transform duration-75 ease-in hover:-translate-y-3`} onClick={() => setSelectedSection(section)}>
