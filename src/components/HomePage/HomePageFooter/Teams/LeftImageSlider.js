    ...
    return(
        <>
            <div className="min-h-[200px] w-full flex flex-row p-2 items-center justify-center">
                <div className=' relative h-[80px] w-[80px] md:h-[200px] md:w-[200px] flex flex-col items-center justify-center overflow-hidden rounded-full bg-black'><img src={image} className='absolute emerge l'></img><h1>{name}</h1></div>
