...
export const Language=({name,img,handleLanguageClick,no,languageOptionHidden})=>{
    ...
    return(
        <>
            <div className={`${selectLanguage===name?'hidden ':`${isMobile ? 'h-[15px]' : 'h-[50px] '}`} shadow-lg hover:bg-cyan-400/30 cursor-pointer  items-center flex justify-centeroverflow-hidden px-2 py-1`}
