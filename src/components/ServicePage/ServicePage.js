...
export const ServicePage=()=>{
    return(
        <>
        <div style={{backgroundImage:`url(${bgImage})`}} className="fixed w-screen h-screen bg-cover bg-center top-0 -z-10">

        </div>
        <div  className="fixed bg-zinc-800/25 bg-center top-0 w-screen h-screen">

              </div>
        
        <div className='w-full h-full bg-cover bg-center py-10 lg:h-screen flex justify-start items-center gap-10 px-14 flex-wrap' >
